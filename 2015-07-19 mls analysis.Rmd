...
1 主要从产品（概述、状态、分类）、店铺（概述、状态）、haodian（概述、状态、评级）等方面对美丽说公司的数据进行了分析。

2 输入：数据时间 20150712（previous），20150719（current）数据库121.43.197.34，表：simple_mls_haodian，simple_mls_sku
...
top10=head(as.data.frame(arrange(hdb,desc(grade),desc(newsales))),10)
